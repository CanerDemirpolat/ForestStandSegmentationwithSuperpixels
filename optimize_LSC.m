...
close all
clc
addpath('C:\Users\caner.demirpolat\Desktop\Subset')
addpath('C:\Users\caner.demirpolat\Desktop\lsc_matlab\lsc_matlab')
...
m=0;
for numsp=2000
for compactness=0.005:0.001:0.4
m=m+1;
...
[xxxTP9(m) xxxFP9(m) xxxTN9(m) xxxFN9(m)] = compareBoundaryImagesSimple(hebe33, sinir, kk);
accur(m) = (xxxTP9(m) + xxxTN9(m))/90000;
end
end
